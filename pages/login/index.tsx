...
export default function LoginPage() {
  ...
  // css - classes
  const mainClass =
      "min-h-screen px-16 pt-12 flex flex-col justify-center lg:pb-8 lg:pt-6 lg:grid lg:grid-cols-4",
    h1Class =
      "font-bold py-auto text-5xl flex flex-col justify-end items-center mt-8",
    formClass =
  ...
  return (
    <div className="relative bg-gradient-to-br from-black from-30% to-indigo-900 text-white">
      <SendEmailModal
        showModal={showModal}
      ...
      <main className={mainClass}>
        <div className="flex flex-col justify-around items-center lg:col-start-1 min-h-[95vh] lg:pt-12 lg:pb-8 lg:pt-6">
