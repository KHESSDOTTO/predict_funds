...
export default function SendEmailModal({
  ...
  const [containerClass, setContainerClass] = useState(
    `transition-all duration-200 absolute top-0 bottom-0 backdrop-blur-md min-h-screen w-full opacity-0 -z-10`
  );
  ...
  useEffect(() => {
    if (showModal) {
      setContainerClass(
        `transition-all duration-200 absolute top-0 bottom-0 backdrop-blur-md min-h-screen w-full opacity-100 z-20`
      );
    } else {
      setContainerClass(
        `transition-all duration-200 absolute top-0 bottom-0 backdrop-blur-md min-h-screen w-full opacity-0 -z-10`
