...
export default function ControlSection({
  ...
  return (
    <>
      ...
      <div
        id="controls"
        className="px-4 mx-4 bg-gradient-to-br from-white from-15% to-white/30 py-4 rounded-xl shadow-lg shadow-indigo-900 text-gray-900 lg:px-0 lg:max-w-[95vw] lg:w-fit lg:h-fit lg:mt-2 lg:bg-none lg:shadow-none lg:text-white"
      >
        <form
